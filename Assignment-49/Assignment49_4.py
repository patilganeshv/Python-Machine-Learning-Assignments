"""
4. Model Evaluation
    .Print the following metrics:Accuracy score, Confusion matrix, Precision, Recall, F1-score
    .Use matplotlib or seaborn to visualize the confusion matrix
"""
...
def diabetes_prediction(datapath):
    ...
    plot_cm(Y_test, y_pred_knn, "KNN CM")
